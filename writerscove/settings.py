"""
Django settings for writerscove project.
...
SECRET_KEY = 'django-insecure-b%6xg-pab-+v#93etw0idp(04o+@!-wa41u(mj6)rroim=sd=u'
...
WSGI_APPLICATION = 'writerscove.wsgi.application'
...
CELERY_BEAT_SCHEDULE = {
    'generate-daily-prompt': {
        'task': 'story.tasks.generate_daily_prompt_task',
